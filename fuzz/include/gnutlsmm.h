...
public:
  ...
  int send_alert(gnutls_alert_level_t level, gnutls_alert_description_t desc);
  ...
  void get_transport_ptr(gnutls_transport_ptr_t & recv_ptr, gnutls_transport_ptr_t & send_ptr) const;
